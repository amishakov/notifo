...
public class CodeGenerator : IIncrementalGenerator
{
    ...
    {
        var testTemplateStream = typeof(CodeGenerator).Assembly.GetManifestResourceStream("Notifo.TestTemplate.handlebar")!;
    ...
    {
        var fixtureTemplateStream = typeof(CodeGenerator).Assembly.GetManifestResourceStream("Notifo.FixtureTemplate.handlebar")!;
