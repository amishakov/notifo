    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ContributorId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DocId = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    AuthDomain = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
                    Counters = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    IsPending = table.Column<bool>(type: "boolean", nullable: false),
                    CountersVersion = table.Column<long>(type: "bigint", nullable: false),
                    Etag = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DocId = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    AppId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Topic = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    SearchText = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    SendChannels = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Counters = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    D = table.Column<byte[]>(type: "bytea", nullable: true),
                    DP = table.Column<byte[]>(type: "bytea", nullable: true),
                    DQ = table.Column<byte[]>(type: "bytea", nullable: true),
                    Exponent = table.Column<byte[]>(type: "bytea", nullable: true),
                    InverseQ = table.Column<byte[]>(type: "bytea", nullable: true),
                    Modulus = table.Column<byte[]>(type: "bytea", nullable: true),
                    P = table.Column<byte[]>(type: "bytea", nullable: true),
                    Q = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FriendlyName = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstWriteId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    ChannelName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    MessageHeaders = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupKey = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Jobs = table.Column<string>(type: "text", nullable: false),
                    Progressing = table.Column<bool>(type: "boolean", nullable: false),
                    ProgressingStarted = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicPrefix = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Etag = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    Doc = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserDocId = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAddress = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Counters = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: true),
                    CountersVersion = table.Column<long>(type: "bigint", nullable: false),
                    Etag = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    Doc = table.Column<string>(type: "text", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotifications_AppId_CorrelationId_Updated_IsDeleted_Cre~",
